...
function () {
  function Gallery(galleryClassName) {
    ...
    this.popUp = new _Popup__WEBPACK_IMPORTED_MODULE_1__["default"](".modal", ".popup__close-button");
  }
  ...
  _createClass(Gallery, [{
    ...
    key: "initShowImageHandler",
    value: function initShowImageHandler() {
      var _this2 = this;

      this.$gallery.addEventListener("click", function (_ref) {
        var target = _ref.target;
        var image = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getClosestByClassName"])(target, "js");
...
/*!*************************!*\
  !*** ./src/js/utils.js ***!
  \*************************/
/*! exports provided: getClosestByClassName, toggleActiveClass */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getClosestByClassName", function() { return getClosestByClassName; });
...
function getClosestByClassName(elem, className) {
  if (elem == null) return null;else return elem.classList.contains(className) ? elem : getClosestByClassName(elem.parentElement, className);
}
